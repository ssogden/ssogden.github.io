---
layout: post
title: "PERFECT Game Server with Pterodactyl and Docker"
date: 2022-10-19 08:00:00 -0000
categories: homelab 
...
[Pterodactyl GitHub repo](https://github.com/pterodactyl/panel) and the [Eggs repo (additional games)](https://github.com/parkervcp/eggs)


## Install Docker

To install docker, see [https://docs.minilabwork.com/posts/docker-compose-install/](https://docs.minilabwork.com/posts/docker-compose-install/)

## Reverse Proxy

If you need to configure your reverse proxy, [see my guide on how to do that](https://docs.minilabwork.com/posts/traefik-portainer-ssl/).
